...
echo "<h2> Enter Details </h2>
<form method='GET' action ='internupdate.php'>
<input type='text' name='nameofintern' placeholder='Name'>
<input type='text' name='skills' placeholder='Skills'>
<input type ='textbox' name='experience' placeholder='Experience'>
<input type='text' name= 'salary' placeholder='Expected Salary'>
<input type='hidden' name='nameofstartup' value='".$nameofstartup."' >
