...
echo "
<div align = 'center'>
<form method='POST' action ='fundupdate.php' enctype='multipart/form-data' class='form-inline'>
<input type='text' name='nameoffunder' placeholder='Name Of Funder'><br><br>
<input type='text' name='nameoforganisation' placeholder='Name of Organisation'><br><br>
<input type ='text' name='website' placeholder='Website'><br><br>
<input type='text' name= 'bid' placeholder='BID'><br><br>
<input type=text' name='email' placeholder='email'><br><br>
<input type='hidden' name='nameofstartup' value='".$nameofstartup."' ><br><br>
