...
<body>
	...
	<section id="team" style="background-color:#bdbdbd">
		
		<div class="container">

			<div class="row title text-center">
				<h1 class="margin-top"><font color="#222">Team Members</font></h1>
				<h4 class="light muted"><font color="#fff">We're a dream team!</font></h4>
			</div>
			<div class="row">
				<div class="col-md-3">
					<div class="team text-center">
						...
						<img src="team/abhishek.jpg" alt="Team Image" class="avatar">
						<div class="title">
							<h4><font color="black"><strong>Abhishek Tripathi</strong></font></h4>
							<h5 class="muted regular">UI/UX Developer</h5>
							<br/>
							<p class="description-team" style="padding: 20px; font-size: 16px;">Abhishek is a college student pursuing his B.Tech degree.
							He is an optimistic person who always thinks of a solution in life rather than being stuck on a single problem. He is a graphic designer having some knowledge of coding stuff too.
                            He does not fear of losing in life.	</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="team text-center">
						...
						<img src="team/aman.jpg" alt="Team Image" class="avatar">
						<div class="title">
							<h4><font color="black"><strong>Aman Nim</strong></font></h4>
							<h5 class="muted regular">UI/UX developer</h5>
							<br/>
							<p class="description-team" style="padding: 20px; font-size: 16px;">Abhishek is a college student pursuing his B.Tech degree.
							He is an optimistic person who always thinks of a solution in life rather than being stuck on a single problem. He is a graphic designer having some knowledge of coding stuff too.
				...
				<div class="col-md-3">
					<div class="team text-center">
						...
						<img src="team/sagar.jpg" alt="Team Image" class="avatar">
						<div class="title">
							<h4><font color="black"><strong>Sagar Kalra</strong></font></h4>
				...
				<div class="col-md-3">
					<div class="team text-center">
						...
						<img src="team/shivam.jpg" alt="Team Image" class="avatar">
						<div class="title">
							<h4><font color="black"><strong>Shivam Singh</strong></font></h4>
							<h5 class="muted regular">Backend developer</h5>
							<br/>
							<p class="description-team" style="padding: 20px; font-size: 16px;">Abhishek is a college student pursuing his B.Tech degree.
							He is an optimistic person who always thinks of a solution in life rather than being stuck on a single problem. He is a graphic designer having some knowledge of coding stuff too.
