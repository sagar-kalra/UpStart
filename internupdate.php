<?php
include 'db.php';
$nameofintern = $_GET['nameofintern'];
$skills = $_GET['skills'];
$experience = $_GET['experience'];
$salary=$_GET['salary'];
$nameofstartup=$_GET['nameofstartup'];

$sql="INSERT INTO intern (NAME, SKILLS, EXPERIENCE, NAMEOFSTARTUP, SALARY) VALUES ('$nameofintern','$skills','$experience','$nameofstartup','$salary')";
...
<div class="alert alert-success">
  <strong>Success!</strong> Yor request has been sent to user.
</div>
<nav class="green">
